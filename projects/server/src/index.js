...
//#region API ROUTES
// Import routes
const { userRouter, profileRouter, addressRouter, branchRouter, suggestionRouter, cartRouter } = require("./routers")
...
const { categoryRouters, productRouters, inventoryRouters, adminRouter, discountRouter, voucherRouter } = require("./routers");
