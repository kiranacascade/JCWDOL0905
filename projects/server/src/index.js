...
//#region API ROUTES
// Import routes
const { userRouter, profileRouter, addressRouter, branchRouter, suggestionRouter, categoryRouters, productRouters, inventoryRouters, adminRouter } = require("./routers")
