            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                <div>
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      ...
                      <div className="text-red-700 text-xs text-left font-semibold">
                        {errorState.provinceName ? errorState.provinceName : null}
                      </div>
                    </div>
                    <div className="mt-2">
                      <label
                      ...
                      <div className="text-red-700 text-xs text-left font-semibold">
                        {errorState.cityName ? errorState.cityName : null}
                      </div>
                    </div>
                  ...
                  <div className="text-red-700 text-xs text-left font-semibold">
                    {" "}
                    {errorState.storeAddress ? errorState.storeAddress : null}{" "}
                  </div>
                </div>
                ...
                <div className="mt-5 sm:mt-6 flex">
                  <button
                    // disabled={ editData.branchName === "" || editData.storeAddress === "" || editData.provinceName === "" || isObjectNotEmpty(errorState) }
                    type="button"
