...
export default function ModalCreateBranchStore({
  open,
  setOpen,
  getListOfStoreData,
}) {
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="flex flex-col mb-3">
                      ...
                      <div className="text-red-700 text-xs text-left font-semibold">
                        {" "}
                        {errorBranchName ? errorBranchName : null}{" "}
                      </div>
                    </div>
                    <div className="mt-2">
                      <label
                      ...
                      <div className="text-red-700 text-xs text-left font-semibold">
                        {errorProvinceName ? errorProvinceName : null}
                      </div>
                    </div>
                    <div className="mt-2">
                      <label
                      ...
                      <div className="text-red-700 text-xs text-left font-semibold">
                        {errorCityName ? errorCityName : null}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col mt-3">
                  ...
                  <div className="text-red-700 text-xs text-left font-semibold">
                    {" "}
                    {errorAddress ? errorAddress : null}{" "}
                  </div>
                </div>
