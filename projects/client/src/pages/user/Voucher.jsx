      ...
      <div className="mx-auto max-w-2xl py-1 px-4 sm:py-8 sm:px-6 md:max-w-4xl md:px-6 md:py-6 lg:max-w-7xl lg:px-8 md:py-6 mb-10">
        ...
        if (isVoucherUsed) {
          ...
          return null;
            ...
            return (
            <div
              className="flex rounded-lg border border-gray-200 min-h-36 h-36 lg:h-36"
              key={voucher.id}
            >
              <div className="flex w-full items-center">
                <div className="flex mr-4 w-44 min-h-28 h-full bg-green-500 rounded-l-lg justify-center items-center">
                  ...
                  {voucher.voucher_type === "shipping" ? (
                    ...
                    <ReceiptPercentIcon
                      ...
                      aria-hidden="true"
                    />
                  ) : voucher.voucher_type === "total purchase" ?(<ShoppingBagIcon
                    className="fill-white block h-9 w-9"
                    aria-hidden="true"
                  />) : (<GiftIcon className="fill-white block h-9 w-9" aria-hidden="true" />)}
                  </div>
                ...
                <div className="justify-end">
                  ...
                  {isVoucherClaimed ? 
                  <button
                  className="m-1 mr-5 w-24 h-8 border border-green-500 hover:border-green-600 text-md font-bold text-green-500 active:border-green-700 rounded-md "
                >
                  Claimed
                </button>
                  :
                  <>
                   {voucher["Statuses"] === "CLAIMABLE" ? (
                    <button
                    className="m-1 mr-5 w-24 h-8 bg-green-500 hover:bg-green-600 text-md font-bold text-white active:bg-green-700 rounded-md"
                  ...
                  >
                    ...
                    <button
                    className="m-1 mr-5 w-24 h-12 border border-gray-400 hover:border-gray-400 text-md font-bold text-gray-400 rounded-md"
                  >
                    Not Claimable
                  </button>
                  )}
